...
--   Application:     149408
--   Name:            Kafka
--   Date and Time:   17:41 Wednesday February 7, 2024
...
,p_last_upd_yyyymmddhh24miss=>'20240207174100'
...
,p_base_url=>nvl(wwv_flow_application_install.get_remote_server_base_url('Kafka_Rest_Proxy_Endpoint'),'http://xxx.xxx.xxx:9999/')
...
,p_last_updated_by=>'PATRICK.MONACO'
,p_last_upd_yyyymmddhh24miss=>'20240207131135'
);
wwv_flow_imp_page.create_page_plug(
...
'cr :=KAFKA_PKG.deleteinstance(:P2_NAME);',
'',
'',
'if cr != ''0'' then',
...
,p_last_updated_by=>'PATRICK.MONACO'
,p_last_upd_yyyymmddhh24miss=>'20240207173824'
);
wwv_flow_imp_page.create_page_plug(
...
'begin',
'',
'cr := KAFKA_PKG.changeoffset(:P2_TOPIC, :P2_NAME, :P3_OFFSET);',
'exception',
'when others then',
'null;',
'end;'))
...
'begin',
'',
'cr := KAFKA_PKG.commitOffset(:P2_NAME);',
'exception',
'    when others then',
'    null;',
'end;'))
...
,p_last_updated_by=>'PATRICK.MONACO'
,p_last_upd_yyyymmddhh24miss=>'20240206193651'
);
wwv_flow_imp_page.create_page_plug(
...
'function sendmsg(pname) {',
'    alert(pname);',
'    /*',
'    var df;',
'    df = this.data.model.getValue(this.data.selectedRecords[0], "NAME");',
'    apex.item("P6_CITY").setValue(df);',
'    df = this.data.model.getValue(this.data.selectedRecords[0], "POPULATION");',
'    apex.item("P6_VALUE").setValue(df);',
'    df = this.data.model.getValue(this.data.selectedRecords[0], "ID");',
'    apex.item("P6_ID").setValue(df);',
'    apex.submit(''ADDMSG'');',
'    */',
'}'))
,p_page_template_options=>'#DEFAULT#'
...
,p_last_updated_by=>'PATRICK.MONACO'
,p_last_upd_yyyymmddhh24miss=>'20240207133651'
);
wwv_flow_imp_page.create_page_plug(
...
,p_region_template_options=>'#DEFAULT#:t-ContentBlock--padded:t-ContentBlock--h2:t-ContentBlock--shadowBG'
...
,p_link_target=>'javascript:sendmsg(''&NAME.'');'
,p_button_display_type=>'TEXT'
,p_is_hot=>false
,p_build_option_id=>wwv_flow_imp.id(56273077951131548065)
);
wwv_flow_imp_page.create_page_button(
...
,p_last_updated_by=>'PATRICK.MONACO'
,p_last_upd_yyyymmddhh24miss=>'20240207104017'
);
wwv_flow_imp_page.create_page_plug(
...
'function commitOffset(pname varchar2) return varchar2;',
'end "KAFKA_PKG";',
'/',
'',
...
'begin',
'   ',
'    turl := tendpoint || ''consumers/'' ||tugroup || ''/instances/'' ||pname || ''/offsets'';',
'    tbody := NULL;',
'    apex_web_service.g_request_headers(1).name  := ''Content-Type''; ',
'    apex_web_service.g_request_headers(1).value := ''application/vnd.kafka.json.v2+json'';',
'    l_clob := APEX_WEB_SERVICE.make_rest_request( ',
