...
--   Application:     149408
--   Name:            Kafka
--   Date and Time:   15:24 Friday February 2, 2024
...
,p_last_upd_yyyymmddhh24miss=>'20240202152412'
...
,p_base_url=>nvl(wwv_flow_application_install.get_remote_server_base_url('Kafka_Rest_Proxy_Endpoint'),'http://xxx.xxxx.xxx:8082/')
...
,p_list_item_link_text=>'NB Points'
...
,p_last_updated_by=>'PATRICK.MONACO'
,p_last_upd_yyyymmddhh24miss=>'20240202151600'
);
...
,p_last_updated_by=>'PATRICK.MONACO'
,p_last_upd_yyyymmddhh24miss=>'20240202152301'
);
wwv_flow_imp_page.create_page_plug(
...
'The REST endpoint which has been given during installation is prohibited on this APEX platform.',
'Either non TLS or specific port instead 80 or 443.',
'Please review Remote Server config in the workspace.'))
...
,p_last_updated_by=>'PATRICK.MONACO'
,p_last_upd_yyyymmddhh24miss=>'20240202104436'
);
wwv_flow_imp_page.create_page_plug(
...
'end;'))
,p_process_clob_language=>'PLSQL'
,p_process_error_message=>'Problem: Instance could''nt be created'
...
,p_last_updated_by=>'PATRICK.MONACO'
,p_last_upd_yyyymmddhh24miss=>'20240202140901'
);
wwv_flow_imp_page.create_page_plug(
...
,p_page_component_map=>'18'
,p_last_updated_by=>'PATRICK.MONACO'
,p_last_upd_yyyymmddhh24miss=>'20240202103251'
);
wwv_flow_imp_page.create_page_plug(
...
,p_query_type=>'SQL'
,p_plug_source_type=>'NATIVE_IR'
,p_prn_page_header=>'Topics V3'
);
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(59241599180129202996)
,p_name=>'Topics V3'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
,p_pagination_type=>'ROWS_X_TO_Y'
...
,p_enable_mail_download=>'Y'
,p_owner=>'PATRICK.MONACO'
,p_internal_uid=>59241599180129202996
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(59241599526216202997)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(59241599946116202997)
,p_db_column_name=>'RELATED'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Related'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
,p_use_as_row_header=>'N'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(59241600302464202997)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(59241600795055202998)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(59241601153674202998)
,p_db_column_name=>'CLUSTER_ID'
,p_display_order=>5
,p_column_identifier=>'E'
,p_column_label=>'Cluster Id'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
,p_use_as_row_header=>'N'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(59241601569790202998)
,p_db_column_name=>'RELATED2'
,p_display_order=>6
,p_column_identifier=>'F'
,p_column_label=>'Related2'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
,p_use_as_row_header=>'N'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(59241601993068202999)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(59241602351298202999)
,p_db_column_name=>'IS_INTERNAL'
,p_display_order=>8
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(59241602736370202999)
,p_db_column_name=>'PARTITIONS_COUNT'
,p_display_order=>9
,p_column_identifier=>'I'
,p_column_label=>'Partitions Count'
,p_column_type=>'NUMBER'
,p_heading_alignment=>'RIGHT'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(59241603199462202999)
,p_db_column_name=>'REPLICATION_FACTOR'
,p_display_order=>10
,p_column_identifier=>'J'
,p_column_label=>'Replication Factor'
,p_column_type=>'NUMBER'
,p_heading_alignment=>'RIGHT'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(59241603566167203000)
,p_db_column_name=>'RELATED3'
,p_display_order=>11
,p_column_identifier=>'K'
,p_column_label=>'Related3'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
,p_use_as_row_header=>'N'
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(59241804329943894470)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'592418044'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'TOPIC_NAME:REPLICATION_FACTOR:PARTITIONS_COUNT:'
);
wwv_flow_imp_shared.create_web_source_comp_param(
...
,p_last_updated_by=>'PATRICK.MONACO'
,p_last_upd_yyyymmddhh24miss=>'20240202145229'
);
wwv_flow_imp_page.create_page_plug(
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(59619720353067849502)
,p_event_id=>wwv_flow_imp.id(56662050908221101340)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
,p_attribute_01=>'NULL;'
,p_attribute_02=>'NAME,POPULATION,P5_CITY,P5_VALUE'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
);
wwv_flow_imp_page.create_page_da_action(
...
'cr varchar2(100);',
'begin',
'cr := kafka_pkg.addmsg(:P5_TOPIC,:P5_CITY,:P5_VALUE);',
'end;'))
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
...
,p_page_component_map=>'16'
,p_last_updated_by=>'PATRICK.MONACO'
,p_last_upd_yyyymmddhh24miss=>'20240202105608'
);
wwv_flow_imp_page.create_page_plug(
...
,p_last_updated_by=>'PATRICK.MONACO'
,p_last_upd_yyyymmddhh24miss=>'20240202145316'
);
wwv_flow_imp_page.create_page_plug(
...
'--tendpoint varchar2(500) :=  apex_application_install.get_remote_server_base_url( ''Kafka_Rest_Proxy_Endpoint'' );',
'--tendpoint varchar2(500) :=  getRemoteServer;',
'tremoteserverid varchar2(100) := ''Kafka_Rest_Proxy_Endpoint'';',
...
'function addmsg(ptopic varchar2, pmsg varchar2, pvalue varchar2)  return varchar2;',
...
'    where REMOTE_SERVER_STATIC_ID = ''Kafka_Rest_Proxy_Endpoint'';',
'    return tbaseurl;',
'end;',
'',
'function createinstance (ptopic varchar2) return varchar2',
...
'--clusterid := apex_json.get_varchar2(p_path=>''data[%d].cluster_id'',p0=> 1,p_values=>l_values);',
